...
public class AppUser implements Serializable {
    ...
    public AppUser(long id, String firstName, String lastName, Date birthDate, Date subscriptionDate, String emailAddress, String login, String password, GenderEnum gender, UserType type) {
        this.id = id;
